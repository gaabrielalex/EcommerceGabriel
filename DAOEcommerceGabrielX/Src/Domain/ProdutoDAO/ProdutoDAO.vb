...
Public Class ProdutoDAO
	...
	Public Function Inserir(produto As Produto) As Integer Implements IDAO(Of Produto).Inserir
		Dim query = "INSERT INTO produto (descricao, preco_unitario, saldo_estoque) VALUES (@descricao, @preco_unitario, @saldo_estoque);
	...
	Public Sub Editar(produto As Produto, id As Integer) Implements IDAO(Of Produto).Editar
		Dim query = "UPDATE produto 
					SET descricao = @descricao, preco_unitario = @preco_unitario, saldo_estoque = @saldo_estoque 
